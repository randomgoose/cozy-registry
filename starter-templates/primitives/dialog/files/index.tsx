...
// @ts-expect-error starter dependency stub is synthesized during project initialization
...
function DialogPreview() {
  return (
    <div className="flex min-h-[320px] items-center justify-center rounded-2xl border border-border bg-background p-6">
      <Dialog defaultOpen>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Invite teammates</DialogTitle>
            <DialogDescription>
              Share access to this starter project so collaborators can review and extend the kit.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
