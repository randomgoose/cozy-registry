...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      >
        <span className={`flex shrink-0 items-center justify-center ${slot} text-amber-500`}>
          <Sun
        ...
        <span className={`flex shrink-0 items-center justify-center ${slot} text-sky-400 dark:text-sky-300`}>
          <Moon
            className="h-7 w-7 transition-transform duration-200 group-hover:-rotate-12"
            strokeWidth={2}
            aria-hidden
