...
- [`20-engineering/team-publish-target-spec.md`](./20-engineering/team-publish-target-spec.md)
- [`20-engineering/project-model-simplification-spec.md`](./20-engineering/project-model-simplification-spec.md)
