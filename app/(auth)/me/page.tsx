        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
              ...
              <span className="font-medium text-zinc-900 dark:text-zinc-100">@{ownerHandle}</span>.
            </p>
          </div>
      ...
      {items.length === 0 ? (
        <div className="mt-10 rounded-[28px] border border-dashed border-zinc-300 bg-white/60 p-6 pb-10 dark:border-zinc-700 dark:bg-zinc-900/30">
          <div className="mx-auto max-w-2xl text-center">
            <p className="text-zinc-700 dark:text-zinc-300">You haven’t published anything yet.</p>
            <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
              Start from the tool you already use. We’ll swap these placeholders with the final walkthrough
              images next.
            </p>
          </div>
          <div className="mt-8">
