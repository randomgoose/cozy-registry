        ...
        <div className="space-y-5">
          <div className="flex items-start justify-between gap-4">
            <div className="space-y-2">
              ...
              <div className="h-4 w-80 max-w-[78%] rounded-full bg-zinc-100 dark:bg-zinc-800/80" />
            </div>
            <div className="h-4 w-20 rounded-full bg-zinc-100 dark:bg-zinc-800/80" />
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2 md:col-span-2">
              <div className="h-3 w-40 rounded-full bg-zinc-100 dark:bg-zinc-800/80" />
              <div className="h-28 rounded-2xl bg-zinc-100 dark:bg-zinc-800/80" />
              <div className="h-3 w-72 max-w-[70%] rounded-full bg-zinc-100 dark:bg-zinc-800/80" />
            </div>
          </div>
